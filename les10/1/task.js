...
for (let index = 0; index < dec.length; index++) {
    dec[index].addEventListener('click', (e) => {
        --e.srcElement.parentElement.querySelector('.product__quantity-value').innerText
    }) 
}
...
for (let index = 0; index < addcart.length; index++) {
    addcart[index].addEventListener('click', (e) => {
        ...
        const count =e.srcElement.parentElement.querySelector('.product__quantity-value').innerText
